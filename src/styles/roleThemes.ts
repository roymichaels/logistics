 ...
 * - Admin: Purple/Violet - Authority and system control
...
// 👑 ADMIN THEME - Purple/Violet (Infrastructure Owner)
export const ADMIN_THEME: RoleTheme = {
  ...
  colors: {
    ...
    glowPrimary: '0 0 20px rgba(156, 109, 255, 0.3)',
    glowPrimaryStrong: '0 0 30px rgba(156, 109, 255, 0.5)',
    glowGold: '0 0 20px rgba(246, 201, 69, 0.3)',
    glowCrimson: '0 0 20px rgba(255, 107, 138, 0.3)',
    ...
    gradientPrimary: 'linear-gradient(135deg, #9c6dff 0%, #7c3aed 100%)',
    gradientGold: 'linear-gradient(135deg, #f6c945 0%, #d4a12a 100%)',
    gradientCrimson: 'linear-gradient(135deg, #ff6b8a 0%, #e84c6f 100%)',
    gradientSuccess: 'linear-gradient(135deg, #10b981 0%, #059669 100%)',
