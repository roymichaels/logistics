...
export const tokens = {
  colors: {
    ...
    text: {
      primary: '#E4E6EB',
      secondary: '#B0B3B8',
      muted: 'rgba(176, 179, 184, 0.6)',
      hint: 'rgba(176, 179, 184, 0.4)',
      bright: '#ffffff',
    },
    brand: {
      primary: '#0084FF',
  ...
  glows: {
    primary: '0 0 12px rgba(0, 132, 255, 0.2)',
    primaryStrong: '0 0 20px rgba(0, 132, 255, 0.3)',
    success: '0 0 12px rgba(0, 184, 124, 0.2)',
    warning: '0 0 12px rgba(241, 196, 15, 0.2)',
    error: '0 0 12px rgba(244, 88, 94, 0.2)',
  },
  ...
  gradients: {
    ...
    warning: '#F1C40F',
    error: '#F4585E',
    card: 'linear-gradient(145deg, #1C1E22 0%, #17181C 100%)',
  },
