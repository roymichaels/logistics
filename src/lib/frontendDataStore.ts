...
// DEPRECATED: Mock products removed - use Supabase SupabaseDataStore instead
// This legacy frontend-only store should not be used for new code
const mockProducts: Product[] = [];

const nowIso = new Date().toISOString();

// DEPRECATED: Driver inventory records - use real Supabase data
...
// DEPRECATED: Driver movements - use real Supabase data
