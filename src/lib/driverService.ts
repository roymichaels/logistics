...
export class DriverService {
  ...
  async createOrUpdateDriverProfile(userId: string, updates: Partial<DriverProfile>): Promise<void> {
    try {
      ...
      console.error('Failed to create/update driver profile:', error);
      throw error;
    }
  }
  ...
  async createOrderAssignment(params: {
    ...
    try {
      ...
      console.error('Failed to create order assignment:', error);
      throw error;
    }
  }
  ...
  async getDriverAssignments(driverId: string, status?: string): Promise<OrderAssignment[]> {
    try {
      ...
      console.error('Failed to get driver assignments:', error);
      return [];
    }
  }
  ...
  async checkAndHandleTimeouts(): Promise<void> {
    try {
      ...
      console.error('Failed to check and handle timeouts:', error);
    }
  }
