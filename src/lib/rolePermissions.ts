...
export interface RolePermissions {
  role: string;
  label: string;
  level: 'platform' | 'business' | 'operational' | 'customer';
  description: string;
...
export const ROLE_PERMISSIONS: Record<string, RolePermissions> = {
  ...
  superadmin: {
    ...
    label: 'Super Admin',
    level: 'platform',
    description: 'Platform-wide administration with access to all businesses and system settings',
    ...
    permissions: [
      ...
      'drivers:manage_status',
      'drivers:view_earnings',
      'drivers:approve_applications',
      'users:view_business',
      'users:create',
      'users:update',
      'users:delete',
