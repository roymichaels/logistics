        ...
        >
          ...
          >
            ...
            <p style={{
              ...
              {user?.role === 'owner' ? 'בעלים' : user?.role === 'manager' ? 'מנהל' : user?.role === 'sales' ? 'מכירות' : user?.role === 'dispatcher' ? 'רכז' : 'נהג'}
            </p>
      ...
      {user && (
        <button
          ...
          style={{
            ...
            borderRadius: '50%',
            background: ROYAL_COLORS.gradientPurple,
            border: `3px solid ${ROYAL_COLORS.backgroundDark}`,
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'translateX(-50%) scale(1.15) rotate(90deg)';
          }}
          onMouseLeave={(e) => {
